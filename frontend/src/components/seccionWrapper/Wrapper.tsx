  ...
  return (
    <section className="content-wrapper">
      <div className="text-wrapper">
        ...
        <p className="parrafo">
          Si eres un entusiasta del desayuno, un conocedor de delicias saladas o
          estás en busca de postres irresistibles, nuestra selección curada
          tiene algo para satisfacer todos los paladares.
        </p>
        <Button className="button-wrapper" text="VER MAS" to="/noticias" />
      </div>
